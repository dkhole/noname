	...
	return (
		...
		>
			<div css={mainWrap}>
				...
				<Product title="KANGAROO" description="Boost Energy + Vitality" merchId="Z2lkOi8vc2hvcGlmeS9Qcm9kdWN0VmFyaWFudC80MDY4NzYwMDU5OTE5NA==" imgBowl={kangaroo} imgPacket={kangarooPack} />
				<Info
					title="WHAT IS IT?"
