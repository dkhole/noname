...
export default function Chicken() {
	...
	return (
		<div css={mainWrap}>
			...
			<Product title="CHICKEN" description="For Sensitive Tummies" merchId="Z2lkOi8vc2hvcGlmeS9Qcm9kdWN0VmFyaWFudC80MDY4NjQyMDk1MTE5NA==" imgBowl={chicken} imgPacket={chickenPack} addToCart={addToCart} setLocalCart={setLocalCart} localCart={localCart} />
			<Info
				title="WHAT IS IT?"
