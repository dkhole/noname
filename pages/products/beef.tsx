...
import beefPack from "../../public/imgs/Beef_trans_packaged.png";
...
export default function Beef() {
	...
	return (
		...
		>
			...
			<Product title="BEEF" description="Our #1 Pick for Picky Eaters" merchId="Z2lkOi8vc2hvcGlmeS9Qcm9kdWN0VmFyaWFudC80MDY4NzYxMTY3NDc3OA==" imgBowl={beef} imgPacket={beefPack} addToCart={addToCart} setLocalCart={setLocalCart} localCart={localCart}/>
			<Info
				title="WHAT IS IT?"
