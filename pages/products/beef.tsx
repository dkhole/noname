	...
	return (
		...
		>
			<div css={mainWrap}>
				...
				<Product title="BEEF" description="Our #1 Pick for Picky Eaters" merchId="Z2lkOi8vc2hvcGlmeS9Qcm9kdWN0VmFyaWFudC80MDY4NzYxMTY3NDc3OA==" imgBowl={beef} imgPacket={beefPack} />
				<Info
					title="WHAT IS IT?"
