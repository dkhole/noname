...
import kangaroo from "../../public/imgs/Roo_trans.png";
import kangarooPack from "../../public/imgs/Roo_trans_packaged.png";
...
export default function Kangaroo() {
	...
	return (
		<div css={mainWrap}>
			...
			<Product title="KANGAROO" description="Boost Energy + Vitality" merchId="Z2lkOi8vc2hvcGlmeS9Qcm9kdWN0VmFyaWFudC80MDY4NzYwMDU5OTE5NA==" imgBowl={kangaroo} imgPacket={kangarooPack} addToCart={addToCart} setLocalCart={setLocalCart} localCart={localCart} />
			<Info
				title="WHAT IS IT?"
